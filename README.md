...
AI & Cybersecurity Engineer | CTF Player | Pentester | Software Engineer

I work at the intersection of **artificial intelligence, offensive security, and software engineering**. My background combines hands-on exploitation experience, strong engineering principles, and applied machine learning, with a focus on building and breaking complex systems.

---

## About Me

I work at the intersection of **artificial intelligence and offensive security**. I am an active **CTF player and pentester** with strong hands-on experience breaking and analyzing systems, and I apply the same attacker mindset when building AI-driven solutions.

My main focus is on **neural networks, computer vision, and applied machine learning**, with a growing interest in how AI can be used for **security automation, intrusion detection, adversarial machine learning, and attack simulation**.

I enjoy environments where I can both **build and break systems**, whether that is through AI competitions, hackathons, CTFs, or independent projects.
...
* AI for Cybersecurity and Adversarial ML
...
* Applying machine learning to security-related data
* AI-assisted detection of anomalous or malicious behavior
* Exploring adversarial attacks against ML models
* Automating parts of penetration testing workflows

---

## Competitions & Learning

* Capture The Flag (CTF) competitions with a focus on real-world exploitation
* AI and machine learning competitions
* Hackathons involving AI, security, and full-stack development
* Continuous self-study across AI, security research, DevOps, and systems
...
If you are interested in AI-driven security, offensive research, or collaborative projects, feel free to connect.
